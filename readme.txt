prefuse alpha README

NOTE: This is the now deprecated alpha version of the prefuse toolkit, provided for backward compatibility with older applications. If you are new to prefuse, please use the beta version instead, which you can download from http://prefuse.org.
