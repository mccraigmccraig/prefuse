 ...
 * creates a new table column whose values are generated by the provided Expression. 
 ...
 *   an existing keyword (e.g., <code>true</code> (boolean literal) vs. <code>[true]</code>
 *   (reference to a data field named 'true').
 * </li>
 * </ul>
 *
 ...
 * </li>
 * <li><strong><code>x ^ y</code> (exponentiation)</strong><br/>
 ...
 * </li>
 * <li><strong><code>x > y</code> (equality)</strong><br/>
 ...
 * </li>
 * <li><strong><code>x OR y, x || y</code> (and)</strong><br/>
 *     Indicates if either <code>x</code> or <code>y</code> is true
 * </li>
 * <li><strong><code>NOT x, !x</code> (and)</strong><br/>
 ...
 *     For the Cartesian coordinates <code>x</code>, <code>y</code> return the polar co-ordinate angle theta
 *   </li>
 *   <li><strong><code>CEIL(x), CEILING(x)</code></strong><br/>
 *     Returna the nearest integer value greater than or equal to <code>x</code>.
 *   </li>
 ...
 *     Returns the value of <em>e</em> (the base of natural logarithms) raised to <code>x</code> power
 *   </li>
 ...
 *     Returns the number of members in the dat group <code>group</code>
 *   </li>
 *   <li><strong><code>INGROUP(group)</code></strong><br/>
 *     Returns true if the current VisualItem is amember of data group <code>group</code>
 *   </li>
 ...
 *     Returns true if the current VisualItem is visible
 *   </li>
