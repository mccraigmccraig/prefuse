 ...
 * column names, data types, and default values. If a schema is subsequently changed,
...
public class Schema implements Cloneable {
    ...
    public int getColumnIndex(String field) {
        ...
        Integer idx = m_lookup.get(field);
