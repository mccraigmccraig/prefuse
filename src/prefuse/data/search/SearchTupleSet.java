...
/**
 2* <p>Abstract base class for TupleSet implementations that support text
 ...
 * searches over the terms indexed using the {@link #index(Iterable, String)}
 ...
 */
public abstract class SearchTupleSet <T extends Tuple<?>> extends DefaultTupleSet<T> {
     ...
     */
    public void index(Iterable<? extends Tuple<?>> tuples, String field) {
        for (Tuple<?> t : tuples) {
            index(t, field);
        }
    }
