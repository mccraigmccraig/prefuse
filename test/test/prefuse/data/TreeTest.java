...
public class TreeTest extends TestCase {
    ...
    public void testTreeReader() {
        ...
        Iterator nodes = t.nodes().iterator();
    ...
    public void testAddChild() {
        ...
        List<Node<?,?>> children = (List<Node<?,?>>) r.children();
        assertEquals(children.get(children.size() - 1), n);
    }
    ...
    public void testRemoveChild() {
        ...
        Node<?,?> r = tree.getRoot();
        Node<?,?> c = r.children().iterator().next();
        ...
        assertEquals(true, r.children().iterator().next() != c);
    }
